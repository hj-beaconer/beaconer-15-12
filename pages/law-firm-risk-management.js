...
import { LegalSeoQuery } from "../Utils/seoEndponts";
import { getServerSidePropsWithData } from "../Utils/getServerSideData";
import SEO from "../Utils/SEO";
import Image from "next/image";
import { bg_lines, grid, technology_bg } from "../Utils/images";
import { generateBeaconerStructuredData } from "../Utils/structuredData";

const legal = ({ Data, fullUrl, setIsPageLoaded }) => {
  const router = useRouter();
  const [legalData, setLegalData] = useState();
  const { getlegal } = useIndustries();
      ...
      {legalData && (
        <>
          <div className="relative mt-32">
            {Data && (
               <SEO
          title="Third Party Risk Management For Law Firm | Beaconer"
          description="Law firms handle sensitive client data that demand security. Beaconer’s AI-driven solution allows legal practices to protect confidential information."
          keywords={[
        ...
        />
              ...
              <div className={style.health_main_container}>
                ...
                <div className={style.second_section_container}>
                  <img
                    ...
                    src={`${process.env.NEXT_PUBLIC_BACKEND_URL}${legalData[0]?.Legal_Hero_Section?.Legal_Hero_Section_Image.url}`}
                    loading="lazy"
                    fetchpriority="high"
                  />
                  <div className={style.second_content_container}>
                    <div
                      ...
                      dangerouslySetInnerHTML={{
                        __html: marked(
                          `${
                            legalData
                              ? legalData[0]?.Legal_Hero_Section
                                  .Legal_Hero_Section_Main_Heading
                    ...
                    <div className={style.second_content_discription}>
                      {legalData
                        ? `${legalData[0].Legal_Hero_Section.Legal_Hero_Section_Main_Description[0].children[0].text}`
                ...
                <div className="relative flex flex-col items-center justify-center ">
                    ...
                    dangerouslySetInnerHTML={{
                      __html: marked(
                        `${
                          legalData
                            ? legalData[0].Legal_Hero_Section
                                .Legal_Hero_Section_Sub_Heading
                  ...
                  <div className={style.seconry_discription}>
                    {legalData
                      ? `${legalData[0].Legal_Hero_Section.Legal_Hero_Section_Sub_Description[0].children[0].text}`
            ...
            {legalData &&
              legalData[0].Legal_Feature_Section.map((item) => (
                <div className={style.main_feature_section}>
                  <div className={style.main_image_container}>
                    <img
                      ...
                      src={
                        item
                          ? `${process.env.NEXT_PUBLIC_BACKEND_URL}${item.Legal_Feature_Section_Image.url}`
                          : blanlimage
                      }
                    ...
                    <div
                      ...
                      dangerouslySetInnerHTML={{
                        __html: marked(
                          `${
                            item
                              ? item.Legal_Feature_Section_Heading
                    ...
                    <div
                      ...
                      dangerouslySetInnerHTML={{
                        __html: marked(
                          `${
                            item
                              ? item.Legal_Feature_Section_Description
            ...
            <div className={style.main_div_for_key_features}>
              <div className={style.main_div_for_key_features}>
                      ...
                      dangerouslySetInnerHTML={{
                        __html: marked(
                          `${
                            legalData
                              ? legalData &&
                                legalData[0]?.Legal_Service_Section[0]
                ...
                <div className={style.main_div_for_card}>
                  {legalData &&
                    legalData[0].Legal_Service_Section[0].Service_Section_Blog?.map(
                      (item, index) => (
            ...
            <div className={style.apart_section_container}>
                ...
                dangerouslySetInnerHTML={{
                  __html: marked(
                    `${
                      legalData
                        ? legalData &&
                          legalData[0]?.What_Sets_Beaconer_Apart.Mian_Heading
                        : "Key Features"
                    }`
                  ),
                }}
              ...
              <div className={style.apart_card_container}>
                {legalData &&
                  legalData[0]?.What_Sets_Beaconer_Apart.Beaconer_Apart_Card_Section.map(
                    (item) => (
                      ...
                      {legalData && (
                        <>
                          <div
                            ...
                            dangerouslySetInnerHTML={{
                              __html: marked(
                                legalData[0].CTA_Section.CTA_Section_Heading
                              ),
                            }}
                          ></div>
                          <p className={style.experient_para}>
                            {
                              legalData[0].CTA_Section
            ...
            {legalData && (
              <div className={style.last_section}>
                <div className={style.Last_heading}>
                  {
                    legalData[0].Feedback_Section.Feedback_Message[0]
                      ?.children[0]?.text
                  }
                </div>
                <Button
                  text={
                    legalData
                      ? legalData[0].Feedback_Section.Feedback_button_text
                      : "GET IN TOUCH"
                  }
                  onClick={() =>
                    router.push(
                      legalData
                        ? legalData[0].Feedback_Section.Feedback_Redirect_url
                        : "/contact"
                    )
                  }
                />
...
export const getServerSideProps = getServerSidePropsWithData(LegalSeoQuery);
