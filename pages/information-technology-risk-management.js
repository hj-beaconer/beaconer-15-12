...
import { TechnologySeoQuery } from "../Utils/seoEndponts";
...
const technology = ({ Data, fullUrl, setIsPageLoaded }) => {
      ...
      {technologyData && (
        <div className="margin_div_children">
          <div className="relative">
            {Data && (
              <SEO
          title="Risk Management In Information Technology | Beaconer"
          description="Beaconer delivers continuous, AI-powered third-party risk assessments & IT risk management solutions to keep your technology infrastructure secure."
          keywords={[
        ...
        />
              ...
              <div className={style.health_main_container}>
                ...
                <div className={style.second_section_container}>
                  <img
                    ...
                    src={`${process.env.NEXT_PUBLIC_BACKEND_URL}${technologyData[0]?.Technology_Hero_Section?.Technology_Hero_Section_Image.url}`}
                    loading="lazy"
                    fetchpriority="high"
                  />
                  <div className={style.second_content_container}>
                    <div
                      ...
                      dangerouslySetInnerHTML={{
                        __html: marked(
                          `${
                            technologyData
                              ? technologyData[0]?.Technology_Hero_Section
                                  .Technology_Hero_Section_Main_Heading
                    ...
                    <div className={style.second_content_discription}>
                      {technologyData
                        ? `${technologyData[0].Technology_Hero_Section.Technology_Hero_Section_Main_Description[0].children[0].text}`
                ...
                <div className="relative flex flex-col items-center justify-center ">
                    ...
                    dangerouslySetInnerHTML={{
                      __html: marked(
                        `${
                          technologyData
                            ? technologyData[0].Technology_Hero_Section
                                .Technology_Hero_Section_Sub_Heading
                  ...
                  <div className={style.seconry_discription}>
                    {technologyData
                      ? `${technologyData[0].Technology_Hero_Section.Technology_Hero_Section_Sub_Description[0].children[0].text}`
            ...
            {technologyData &&
              technologyData[0].Technology_Feature_Section.map((item) => (
                <div className={style.main_feature_section}>
                  <div className={style.main_image_container}>
                    <img
                      ...
                      src={
                        item
                          ? `${process.env.NEXT_PUBLIC_BACKEND_URL}${item.Technology_Feature_Section_Image.url}`
                          : blanlimage
                      }
                    ...
                    <div
                      ...
                      dangerouslySetInnerHTML={{
                        __html: marked(
                          `${
                            item
                              ? item.Technology_Feature_Section_Heading
                    ...
                    <div
                      ...
                      dangerouslySetInnerHTML={{
                        __html: marked(
                          `${
                            item
                              ? item.Technology_Feature_Section_Description
            ...
            <div className={style.main_div_for_key_features}>
              <div className={style.main_div_for_key_features}>
                <div className={style.main_div_for_key_features_detail}>
                      ...
                      dangerouslySetInnerHTML={{
                        __html: marked(
                          `${
                            technologyData
                              ? technologyData &&
                                technologyData[0]?.Technology_Company_Section
                                  .Technology_Company_Section_Heading
                              : "Key Features"
                          }`
                        ),
                      }}
                  ...
                  <Description
                    ...
                    text={
                      technologyData
                        ? technologyData[0]?.Technology_Company_Section
                            .Technology_Company_Section_Description[0]
                            .children[0].text
                ...
                <div className={style.main_div_for_card}>
                  {technologyData &&
                    technologyData[0].Technology_Company_Section.Company_Blog.map(
                      (item, index) => (
            ...
            <div className={style.apart_section_container}>
                ...
                dangerouslySetInnerHTML={{
                  __html: marked(
                    `${
                      technologyData
                        ? technologyData &&
                          technologyData[0]?.What_Sets_Beaconer_Apart
                            .Mian_Heading
                        : "Key Features"
                    }`
                  ),
              ...
              <div className={style.apart_card_container}>
                {technologyData &&
                  technologyData[0]?.What_Sets_Beaconer_Apart.Beaconer_Apart_Card_Section.map(
                    (item) => (
            ...
            {technologyData && (
              <div className={style.last_section}>
                <div className={style.Last_heading}>
                  {
                    technologyData[0].Feedback_Section.Feedback_Message[0]
                      ?.children[0]?.text
                  }
                </div>
                <Button
                  text={
                    technologyData
                      ? technologyData[0].Feedback_Section.Feedback_button_text
                      : "GET IN TOUCH"
                  }
                  onClick={() =>
                    router.push(
                      technologyData
                        ? technologyData[0].Feedback_Section
...
export const getServerSideProps =
  getServerSidePropsWithData(TechnologySeoQuery);
